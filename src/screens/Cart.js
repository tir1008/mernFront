          ...
          <tbody>
            {data.map((food, index) => (
              <tr>
                ...
                <td ><button type="button" className="btn p-0" style={{color:"black",justifyContent:"center",alignContent:"center",alignItems:"center"}}><DeleteIcon onClick={() => { dispatch({ type: "REMOVE", index: index }) }} /></button> </td></tr>
            ))}
          </tbody>
        </table>
